...
(
    ...
    UPDATE_DT     TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE
);
-- HOST 테이블
CREATE TABLE HOST
(
...
(
    ...
    START_DT    TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE,
    END_DT      TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE,
    INPUT_DT    TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    UPDATE_DT   TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE,
