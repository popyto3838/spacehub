...
import {Badge, Box, Flex, Heading, Image, Text, useToast, VStack} from '@chakra-ui/react';
    ...
    >
      ...
      <VStack p={6} spacing={3} align="stretch">
        ...
        <Text fontWeight="bold" fontSize="xl" color="teal.600">
          ₩{space.price.toLocaleString()}<Text as='span' color='gray.500' fontSize='sm'> / 시간</Text>
        </Text>
